...
<!DOCTYPE html>
  <html>
    <head>
      ...
      <!-- llamamos iconos de materialize -->
      <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
      <!-- llamamos materialize -->
      <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/1.0.0/css/materialize.min.css">
      <!-- <link type="text/css" rel="stylesheet" href="css/materialize.min.css"/> -->
      <link rel="stylesheet" type="text/css"  href="http://localhost/trabajoFinalPHP/css/estilos.css">
        ...
        <header>
                ...
                <a href="index.php" class="brand-logo" >Pisca Andina</a>
                 ...
                 if ($_SESSION['rol']!="user" && $_SESSION['rol']!='admin'){?>
                  <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="login1.php">Login</a></li><i class="Small material-icons">person</i>
                 </ul> 
                <?php } ?>
              </div>
            </nav>
            ...
            <div class="row container">
                    ...
                    <div class="col s12 m4">
                        <div class="card">
                            <div class="card-image">
                                <img class="materialboxed" src="assets/images/cafe.jpg" alt="Taza de café">
