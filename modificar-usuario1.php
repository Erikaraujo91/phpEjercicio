<!DOCTYPE html>
            ...
            <section>
                <div class="row container">
                    <div class="col s12 center about">
                        <h2>Modificación de usuarios</h2><br>
                        <h6>En este apartado el administrador podrá modificar usuarios de la web</h6><br>
                    </div>
                </div>
            </section>
            <?php
  ...
  ?>
        ...
        <form method="get" action="modificar-usuario2.php">
            ...
            Usuario:<input type="text" class="form-control" name="usuario" size="25" value="<?php echo $reg['usuario']; ?>">
            Contraseña:<input type="text" class="form-control" name="password" size="25" value="<?php echo $reg['password']; ?>">
            Rol:<input type="text" class="form-control" name="rol" size="25" value="<?php echo $reg['rol']; ?>">
            <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-sm-offset-3"><input type="submit" class="form-control btn btn-primary " name="enviar" tabindex="7" value="Modificar Usuario"></div>
        </form>
            </div>
  <?php
    }      else
